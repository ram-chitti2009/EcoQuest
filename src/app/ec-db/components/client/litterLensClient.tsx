...
import { Camera, Upload, MapPin, Leaf, BarChart3, Users, Target } from "lucide-react"
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900">Litter Lens</h1>
              <p className="text-sm text-gray-500">EcoQuest&apos;s Trash AI</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <span className="text-sm text-gray-500">🕐 4:52:14 PM</span>
            <span className="text-sm text-gray-500">📅 8/5/2025</span>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="h-48 bg-gray-50 rounded-lg flex items-center justify-center">
                  <p className="text-gray-500">Chart will show cleanup progress as you make reports</p>
                </div>
              </CardContent>
            </Card>
          </div>
