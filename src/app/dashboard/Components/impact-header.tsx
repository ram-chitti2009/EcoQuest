...
export const ImpactHeader = ({ totalCarbonSaved, currentRank, userName }: ImpactHeaderProps) => {
  return (
    <div className="mb-6 md:mb-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-0">
        <div className="text-center md:text-left">
          <h1 className="text-2xl md:text-4xl font-bold text-gray-800 mb-1 md:mb-2">Hello,</h1>
          <h2 className="text-2xl md:text-4xl font-bold text-emerald-600">{userName}</h2>
        </div>
